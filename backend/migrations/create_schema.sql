-- Schema creation for Citizen Engagement System database (DEPLOYMENT VERSION)
-- This file contains CREATE TABLE statements for setting up a fresh database in production
